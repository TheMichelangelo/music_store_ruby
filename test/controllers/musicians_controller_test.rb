...
class MusiciansControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create musician" do
    assert_difference('Musician.count') do
      post musicians_url, params: { musician: { age: @musician.age, home_adress: @musician.home_adress, name: @musician.name, studio_id: @musician.studio_id, surname: @musician.surname } }
    end
  ...
  test "should update musician" do
    patch musician_url(@musician), params: { musician: { age: @musician.age, home_adress: @musician.home_adress, name: @musician.name, studio_id: @musician.studio_id, surname: @musician.surname } }
